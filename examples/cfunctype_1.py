...
def bytes_to_float(ss: argtypes.c_char_p, se: argtypes.Pointer[ctypes.c_char_p]) -> restype.c_double: ...
...
cp = ctypes.c_char_p()
assert -1e7 < bytes_to_float(b"1203.46lalala", ctypes.byref(cp)) - 1203.46 < 1e7
